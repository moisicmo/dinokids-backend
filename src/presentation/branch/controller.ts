...
export class BranchController {
  ...
  getBranches = async (req: Request, res: Response) => {
    ...
    this.branchService.getBranches(paginationDto!)
  ...
  createBranch = (req: Request, res: Response) => {
    ...
    this.branchService.createBranch(branchDto!, req.body.user)
  ...
  updateBranch = (req: Request, res: Response) => {
    ...
    this.branchService.updateBranch(branchDto!, req.body.user, parseInt(req.params.id))
      .then(branch => res.status(201).json(branch))
      .catch(error => this.handleError(error, res));
  ...
  deleteBranch = (req: Request, res: Response) => {
    ...
    this.branchService.deleteBranch(req.body.user, parseInt(req.params.id))
      .then(branch => res.status(201).json(branch))
      .catch(error => this.handleError(error, res));
