...
export class TutorController {
  ...
  getTutors = async (req: Request, res: Response) => {
    ...
    this.service.getTutors(paginationDto!)
  ...
  createTutor = (req: Request, res: Response) => {
    ...
    this.service.createTutor(createTeacherDto!, req.body.user)
  ...
  updateTutor = (req: Request, res: Response) => {
    ...
    this.service.updateTutor(updateTeacherDto!, req.body.user, parseInt(req.params.id))
      .then(data => res.status(201).json(data))
      .catch(error => this.handleError(error, res));
  ...
  deleteTutor = (req: Request, res: Response) => {
    ...
    this.service.deleteTutor(req.body.user, parseInt(req.params.id))
      .then(data => res.status(201).json(data))
      .catch(error => this.handleError(error, res));
